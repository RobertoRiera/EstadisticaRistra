...
public class Practica extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == btOk) {
            ...
            String s = JOptionPane.showInputDialog(null, "Palabra:",
                    "Frecuencia de una palabra", JOptionPane.INFORMATION_MESSAGE);
            JOptionPane.showMessageDialog(null, es.frecuenciaPalabra(s),
                    "frecuencia de la palabra", JOptionPane.INFORMATION_MESSAGE);

        } else if (e.getSource() == btPalabrasMasF) {
            JOptionPane.showMessageDialog(null, es.másFrecuentes(100),
                    "Palabras mas frecuente", JOptionPane.INFORMATION_MESSAGE);
        }
    }
